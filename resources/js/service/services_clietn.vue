...
const themeLogoAlt = computed(() => props.service.dealer?.theme?.name ?? props.service.dealer?.name ?? '')
const themeContactDescription = computed(() => props.service.dealer?.theme?.contact_description ?? '')
const themeFooterHtml = computed(() => props.service.dealer?.theme?.footer_html ?? ``)
